        ...
        <div class="col">
            <div class="row">
                @foreach($products as $product)
                    ...
                    <div class="card">
                        <img class="card-img-top" src="{{ pare_url_file($product->pro_avatar) }}" alt="Card image cap">
                        <div class="card-body">
                            <h4 class="card-title"><a href="product.html" title="View Product">{{ $product->pro_name }}</a></h4>
                            <p class="card-text">{{ $product->pro_description }}</p>
                            <div class="row">
                                <div class="col">
