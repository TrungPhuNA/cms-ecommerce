...
/***/ "./resources/js/components/run_messages.js":
/*!*************************************************!*\
  !*** ./resources/js/components/run_messages.js ***!
  \*************************************************/
...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _run_notifi__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./run_notifi */ "./resources/js/components/run_notifi.js");
...
var RunMessages = {
  ...
  runMessages: function runMessages() {
    if (typeof TYPE_MESSAGE != "undefined") {
      switch (TYPE_MESSAGE) {
        case 'success':
          Object(_run_notifi__WEBPACK_IMPORTED_MODULE_0__["notify"])(MESSAGE, 'success');
          break;

        case 'error':
          Object(_run_notifi__WEBPACK_IMPORTED_MODULE_0__["notify"])(MESSAGE, 'error');
          break;
      }
    }
  }
};
/* harmony default export */ __webpack_exports__["default"] = (RunMessages);
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js")))

/***/ }),

/***/ "./resources/js/components/run_notifi.js":
/*!***********************************************!*\
  !*** ./resources/js/components/run_notifi.js ***!
  \***********************************************/
/*! exports provided: notify, toastSw2, confirmSw2, alertSw2 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "notify", function() { return notify; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "toastSw2", function() { return toastSw2; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "confirmSw2", function() { return confirmSw2; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "alertSw2", function() { return alertSw2; });
/* harmony import */ var toastr__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! toastr */ "./node_modules/toastr/toastr.js");
/* harmony import */ var toastr__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(toastr__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! sweetalert2 */ "./node_modules/sweetalert2/dist/sweetalert2.all.js");
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(sweetalert2__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _library_growl_notification_growl_notification_min__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../library/growl-notification/growl-notification.min */ "./resources/library/growl-notification/growl-notification.min.js");
/* harmony import */ var _library_growl_notification_growl_notification_min__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_library_growl_notification_growl_notification_min__WEBPACK_IMPORTED_MODULE_2__);



var notify = function notify(text) {
  var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'success';
  var title = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'Thông báo';
  new _library_growl_notification_growl_notification_min__WEBPACK_IMPORTED_MODULE_2___default.a({
    title: title,
    description: text,
    type: type,
...
var toastSw2 = sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.mixin({
  toast: true,
  position: 'top-right',
...
var confirmSw2 = sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.mixin({
  type: 'warning',
...
var alertSw2 = sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.mixin({
  type: 'warning',
  confirmButtonColor: '#fb236a',
  cancelButtonColor: '#494d89',
  confirmButtonText: 'Đồng ý'
...
/***/ "./resources/js/user/components/password.js":
/*!**************************************************!*\
  !*** ./resources/js/user/components/password.js ***!
  \**************************************************/
/*! exports provided: default */
...
var Password = {
  ...
  updatePassword: function updatePassword() {
    $(".js-update-password").click(function (event) {
      ...
      var ajax = $.ajax({
        url: URL,
        beforeSend: function beforeSend() {// $(".js-sk-circle").show();
        },
        method: "POST",
        data: $form.serialize()
      });
      ...
      ajax.done(function (results) {
        if (results.code === 200) {
          $.modal.close();
          toastr__WEBPACK_IMPORTED_MODULE_0___default.a.success("Cập nhật thành công");
        } else {
          toastr__WEBPACK_IMPORTED_MODULE_0___default.a.error("Cập nhật thất bại");
        }
      });
    });
  }
...
/***/ "./resources/js/user/pages/dashboard.js":
/*!**********************************************!*\
  !*** ./resources/js/user/pages/dashboard.js ***!
  \**********************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _components_run_messages__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../components/run_messages */ "./resources/js/components/run_messages.js");
/* harmony import */ var _components_password__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/password */ "./resources/js/user/components/password.js");
...
var UserDashboard = {
  init: function init() {
    _components_run_messages__WEBPACK_IMPORTED_MODULE_0__["default"].init();
  }
};
$(function () {
  UserDashboard.init();
  _components_password__WEBPACK_IMPORTED_MODULE_1__["default"].init();
});
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js")))

/***/ }),

/***/ "./resources/library/growl-notification/growl-notification.min.js":
/*!************************************************************************!*\
  !*** ./resources/library/growl-notification/growl-notification.min.js ***!
  \************************************************************************/
/*! no static exports found */
...
!function (t, i) {
  "object" == ( false ? undefined : _typeof(exports)) && "object" == ( false ? undefined : _typeof(module)) ? module.exports = i() :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_FACTORY__ = (i),
  ...
  return function (t) {
    ...
    return o.m = t, o.c = i, o.d = function (t, i, n) {
      ...
      if (o.r(n), Object.defineProperty(n, "default", {
        enumerable: !0,
        value: t
      }), 2 & i && "string" != typeof t) for (var e in t) {
        o.d(n, e, function (i) {
          return t[i];
        }.bind(null, e));
      }
    ...
    var n = function () {
      function t(i, o) {
        if (this.nodes = [], this.pseudoSelector = "", this.callbacks = {}, o || (o = document), "string" == typeof i) {
          if ("<" === i[0] && ">" === i[i.length - 1]) this.nodes = [t.createNode(i)];else {
...
/***/ 4:
/*!****************************************************!*\
  !*** multi ./resources/js/user/pages/dashboard.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/trungphuna/Documents/work/web/duan/cms-ecommerce/resources/js/user/pages/dashboard.js */"./resources/js/user/pages/dashboard.js");
